    ...
    <div className="flex h-screen w-full">
      ...
      >
        ...
        <div className="flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold">
          ...
          <p className="text-2xl md:text-3xl text-balance z-10 text-white">
            The <span className="bg-red-500 px-2 font-bold">ULTIMATE</span> chat
            app
          </p>

          <p className="text-2xl md:text-3xl mb-32 text-balance z-10 text-white">
            You <span className="bg-green-500/90 font-bold px-2">NEED TO</span>{" "}
            build
          </p>
          <AuthButtons />
        </div>
